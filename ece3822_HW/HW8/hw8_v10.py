...
# ------------------- This length of code runs about 4mins 30 seconds -----------------------
    ...
    # end of with file open statement

# ------------------- This length of code runs 99mins+ ------------------------
# Did not see the end of this program at this checkpoint...
